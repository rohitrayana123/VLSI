...
# <+Last Edited: Mon 28 Apr 2014 19:27:45 BST by seblovett on seblovett-Ubuntu +>
# @author seblovett
...
if "__main__" == __name__:
	...
	#parse the options
	#interactive mode?
	parser = OptionParser(usage="sim.py [-t type] [-m module.sv / -p program.asm ] [ -s switchvalue ] [ -gd ] +define+extra_definitions", version="3", description="trailing arguments are given to the simulator directly")
