...
Memory access violations are tested using the \todo[color=red]{HSL: @AJR - please complete this} along with the entire system as a larger framework is required.
