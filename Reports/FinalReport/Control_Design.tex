...
\begin{figure}[ht]
   \centering
    \includegraphics[width = 0.2\textwidth]{FetchASM.pdf}
		\caption{ASM chart of sub state transistions in the featch stage.}% \todo[inline]{Maybe change to IEEE symbols if we have time, AJR: we still have the eagle d-types but I think it would look a bit messy} }
   \label{fig:MainStateASM}
\end{figure}
