\newgeometry{textheight=592pt} %, textwidth=196mm}
\begin{minipage}[c]{\linewidth}
\chapter{Instruction Set Summary}
\label{chap:AppISS}

\vspace{5mm}
\makebox[\textwidth-60pt]{
\centering
\footnotesize
\renewcommand{\arraystretch}{1}
\begin{tabular}{r|c|c|c|c|c|c|c|}
	\multicolumn{1}{c}{} & \multicolumn{1}{c}{\bf Mnemonic} & \multicolumn{1}{c}{\bf Syntax} & \multicolumn{1}{c}{\bf Semantics} & \multicolumn{1}{c}{\bf Flags} & \multicolumn{1}{c}{\bf } & \multicolumn{1}{c}{\bf Opcode} & \multicolumn{1}{c}{\bf Cond} \\
	\cline{2-8}
