...
The caller does one \texbf{POP} followed by two dummy pops to return the stack its initial state.
...
\begin{figure}[!htb]
	\centering
	\subfigure[Stack state during \emph{one} main matter.]{\includegraphics[width=0.3\textwidth]{Figures/oneStack.pdf}
	\label{fig:stack1}}
