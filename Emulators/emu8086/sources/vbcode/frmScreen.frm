...
Begin VB.Form frmScreen 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   490
   Begin VB.PictureBox picHotKeyNotice 
      Appearance      =   0  'Flat
      BackColor       =   &H0000FF00&
      ForeColor       =   &H80000008&
      Height          =   375
      ...
      Visible         =   0   'False
      Width           =   3045
      Begin VB.Label lblHotKeyNotice 
         Alignment       =   2  'Center
         Appearance      =   0  'Flat
         BackColor       =   &H80000005&
         BackStyle       =   0  'Transparent
         Caption         =   "SCREEN_HOTKEYS=false"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      End
   End
   Begin VB.Timer timerHideHotKeyNotice 
      Enabled         =   0   'False
      Interval        =   7000
      Left            =   6540
      Top             =   4575
...
'''    End If
    ...
    frmEmulation.sliderSTEPDELAY.Enabled = True '#1138 BETTER FIX!
