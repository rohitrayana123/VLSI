...
On Error GoTo err1:
    ...
    Else
       ...
       If MsgBox("Would you like to overwrite this file: " & vbNewLine & sFileName & vbNewLine & "  and save a backup as: " & " " & vbNewLine & sBackup & " ? " & vbNewLine & vbNewLine & vbNewLine & "To turn off automatic backup set ALWAYS_BACKUP=false in emu8086.ini", vbYesNo, cMT("overwrite?")) = vbYes Then
            ' save backup:
