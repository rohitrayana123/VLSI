...
'''''''''''''''''''''''''''
    ...
    ''' it seems it doesn't work with T-Online browser... what the shit?
...
' this function isn't used here, just copied from Magic Button:
Public Function CheckAssosiation() As Boolean ' returns TRUE if not associated!!!
