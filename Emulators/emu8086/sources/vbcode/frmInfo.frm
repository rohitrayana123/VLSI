...
Begin VB.Form frmInfo 
   ...
   Begin VB.CommandButton cmdExternal 
      ...
      OLEDropMode     =   1  'Manual
      TabIndex        =   3
      ToolTipText     =   "load this file to debug.exe  (external)"
      Top             =   4425
      Width           =   1845
   End
   ...
   Begin VB.CommandButton cmdEmulate 
      ...
      Left            =   3180
      OLEDropMode     =   1  'Manual
      Picture         =   "frmInfo.frx":038A
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   4125
      Width           =   1845
   End
   Begin VB.CommandButton cmdBrowseMyBuild 
      Caption         =   "view..."
      Height          =   315
      Left            =   60
      OLEDropMode     =   1  'Manual
   ...
   Begin VB.Menu mnuView 
      ...
      Begin VB.Menu mnuShowListing 
         Caption         =   "listing"
      End
      Begin VB.Menu mnuDelimeter0001 
         Caption         =   "-"
      End
...
On Error GoTo err_fr
    ...
    lstErr.Height = cmdEmulate.Top - lstErr.Top - cmdEmulate.Height / 3   ' 2005-7-23
...
On Error Resume Next
    ...
    mnuShowListing.Enabled = FileExists(sLAST_COMPILED_FILE & ".list") Or FileExists(CutExtension(sLAST_COMPILED_FILE) & ".lst")
