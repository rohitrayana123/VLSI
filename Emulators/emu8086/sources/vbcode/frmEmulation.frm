...
Begin VB.Form frmEmulation 
   ...
   ScaleHeight     =   5760
   ScaleWidth      =   8475
   Begin VB.PictureBox picPleaseWait 
      Appearance      =   0  'Flat
      BackColor       =   &H00FF0000&
      ForeColor       =   &H80000008&
      Height          =   960
   ...
   Begin VB.CommandButton cmdLog 
      ...
      Left            =   5810
      TabIndex        =   31
      ToolTipText     =   "log and debug.exe emulation"
      Top             =   5265
      Width           =   720
   End
   ...
   Begin VB.CommandButton cmdBack 
      ...
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "revert the changes made by previous step forward"
      Top             =   30
      UseMaskColor    =   -1  'True
      Width           =   1170
   End
   Begin MSComctlLib.Slider sliderSTEPDELAY 
      Height          =   240
      Left            =   6285
      TabIndex        =   5
      Top             =   30
   ...
   Begin VB.CommandButton cmdReload 
      ...
      Style           =   1  'Graphical
      TabIndex        =   1
      ToolTipText     =   "reload executable file"
      Top             =   30
      UseMaskColor    =   -1  'True
      Width           =   1170
   End
   ...
   Begin VB.CommandButton cmdStack 
      ...
      Width           =   765
   End
   Begin VB.CommandButton cmdShowActualSource 
      Caption         =   "source"
      Height          =   375
      Left            =   2719
      TabIndex        =   27
      ToolTipText     =   "original source code"
      Top             =   5265
      Width           =   705
   End
   ...
   Begin VB.CheckBox chkAutoStep 
      ...
      Style           =   1  'Graphical
      TabIndex        =   4
      ToolTipText     =   "make [single steps] automatically"
      Top             =   30
      UseMaskColor    =   -1  'True
      Width           =   1170
   End
   ...
   Begin VB.CommandButton cmdStep 
      ...
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "process instruction at CS:IP"
      Top             =   30
      UseMaskColor    =   -1  'True
      Width           =   1170
   End
   Begin VB.CommandButton cmdLoad 
      ...
      Style           =   1  'Graphical
      TabIndex        =   0
      ToolTipText     =   "load executable file to emulator"
      Top             =   30
      UseMaskColor    =   -1  'True
      Width           =   1170
   End
...
On Error Resume Next
    ...
    ' #400b22-view-listing-st#
    mnuListing_AUX.Enabled = FileExists(sOpenedExecutable & ".list")
    mnuSymbol_AUX.Enabled = FileExists(sOpenedExecutable & ".symbol")
...
On Error GoTo err1
    ...
    ' #400b22-view-listing-st#
    mnuShowListing.Enabled = FileExists(sOpenedExecutable & ".list") Or FileExists(CutExtension(sOpenedExecutable) & ".lst")
    mnuShowSymbolTable.Enabled = FileExists(sOpenedExecutable & ".symbol")
...
''''    End If
    ...
    lblStepTime.Caption = cMT("step delay ms:") & " " & timerStep.Interval ' 2.09#569
...
Private Sub sliderSTEPDELAY_Scroll()
On Error Resume Next ' 4.00-Beta-3
    sliderSTEPDELAY_Change
End Sub
...
On Error GoTo err_on_prepare
    ...
    sFilename = Add_BackSlash(App.Path) & "BIOS_ROM"
