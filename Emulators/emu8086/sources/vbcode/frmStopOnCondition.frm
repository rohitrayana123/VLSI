...
Begin VB.Form frmStopOnCondition 
   ...
   Begin VB.CommandButton cmdHelp 
      Height          =   360
      Left            =   5805
      Picture         =   "frmStopOnCondition.frx":0D4A
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   810
      UseMaskColor    =   -1  'True
   ...
   Begin VB.ComboBox comboCondition 
      Height          =   345
      ItemData        =   "frmStopOnCondition.frx":0E4C
      Left            =   2145
      List            =   "frmStopOnCondition.frx":0E62
   ...
   Begin VB.ComboBox comboRegisterName 
      Height          =   345
      ItemData        =   "frmStopOnCondition.frx":0E99
      Left            =   165
      List            =   "frmStopOnCondition.frx":0EE2
      Style           =   2  'Dropdown List
      TabIndex        =   0
      Top             =   345
      Width           =   1860
