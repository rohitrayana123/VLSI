...
Const default_steps_back_to_keep As Integer = 200 ' DEFAULT limit to 200 steps back (can be changed in emu8086.ini)
...
' #327spf2#
Const default_Maximum_Files_to_Track As Integer = 200 ' DEFAULT limit to 200 filenames (can be changed in emu8086.ini)
...
' it is possible to turn off step back from emu8086.ini
