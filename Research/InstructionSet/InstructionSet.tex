...
\begin{table}[htb]
	...
	\end{tabular}
	\caption{\label{tab:Correlation}Correlation of architecture features to binary file size \cite{Density:Correlations}}
\end{table}
...
\newpage
\lstinputlisting[label=lst:AlphaFibon,frame=single,caption=DEC Alpha Fibonnaci]{Code/AlphaFibon.asm}
...
Word Count: 1685%Manually insert word count, or use online tool/script
