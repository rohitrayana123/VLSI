%% <+Last Edited: Wed 12 Feb 2014 22:03:01 GMT by seblovett on seblovett-Ubuntu +>
...
\begin{lstlisting}[frame=single,caption=Thumb/Thumb2 Assembler for code in listing \ref{ListC1},label=ARM1]
.def a=$r1
.def i=$r2
